                        ...
                        <a href="/"
                            ...
                            <svg width="22" height="22" viewBox="0 0 22 22" class="mr-2">
                                <g fill="none" fill-rule="evenodd">
                                    <path stroke="#000" stroke-opacity=".012" storke-width=".5" d="M21 1v20.16h.84V1z">
                                    </path>
                                    <path class="fill-current"
                                        d="M13.854 7.224l-3.847 3.847 3.856-1.184 1.184-5.04-5.04-5.04 5.04-5.04z">
                                    </path>
                                </g>
                            </svg>
                            Back to Posts
                        ...
                        <x-panel>
                            ...
                            <form method="POST" action="/posts/{{ $post->slug }}/comments">
                                ...
                                <div class="flex justify-end mt-6 pt-6 border-t border-gray-200">
                                    <button type="submit"
                                        class="bg-blue-500 text-white font-semibold uppercase text-xs py-2 px-10 rounded-2xl">Post</button>
                                </div>
